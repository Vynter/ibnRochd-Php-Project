...
INSERT INTO `loisir` (`id_loisir`, `description`, `id`) VALUES
(1, 'Sport', 2),
(2, 'Voyage', 2),
(3, 'Lecture', 2),
(4, 'Voyage', 1);
...
--
ALTER TABLE `loisir`
  ADD CONSTRAINT `candidaloisir` FOREIGN KEY (`id`) REFERENCES `candidat` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
